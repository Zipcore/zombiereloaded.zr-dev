...
LINES_TOTAL="$(($LINES_MAIN + $LINES_BASE + $LINES_OTHER + $LINES_HEADERS + $LINES_PLAYERCLASSES + $LINES_SOUNDEFFECTS + $LINES_VISUALEFFECTS + $LINES_VOLFEATURES + $LINES_WEAPONS))"
